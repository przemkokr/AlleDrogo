...
namespace AlleDrogo.Persistance.Migrations
{
    ...
    [Migration("20220604175824_added_rating")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AlleDrogo.Domain.Entities.Auction.Rating", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AlleDrogo.Domain.Entities.Auction.Auction", b =>
                {
                    ...
                    b.HasOne("AlleDrogo.Domain.Entities.AppUser.ApplicationUser", "Winner")
                        .WithMany()
            ...
            modelBuilder.Entity("AlleDrogo.Domain.Entities.Auction.Rating", b =>
                {
                    ...
                    b.HasOne("AlleDrogo.Domain.Entities.AppUser.ApplicationUser", "EvaluatedUser")
                        .WithMany("ListOfRatings")
                        .HasForeignKey("EvaluatedUserId");

                    b.HasOne("AlleDrogo.Domain.Entities.AppUser.ApplicationUser", "Evaluator")
                        .WithMany()
